    ...
    <section className="py-16 px-6 md:px-12 bg-gradient-to-b from-purple-50 to-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Text Content */}
          <div className="text-center lg:text-right animate-on-scroll opacity-0" data-animation="fade-up">
            <h2 className="text-4xl font-bold gradient-text mb-6">🚀 נסו את Roxane AI עכשיו – גישה מוקדמת!</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto lg:mr-0">
          ...
          {/* GIF Display Column */}
          <div className="animate-on-scroll opacity-0" data-animation="fade-right">
            <div className="glass-card p-6 rounded-2xl overflow-hidden">
              <div className="relative aspect-video rounded-xl overflow-hidden shadow-xl border-2 border-purple-100">
                ...
                <img 
                  src="/showcase.gif" 
                  alt="Roxane AI showcase" 
                  className="w-full h-full object-cover"
                />
              </div>
              
              <div className="text-center mt-6">
                <h3 className="text-xl font-bold gradient-text mb-2">Roxane AI בפעולה</h3>
                <p className="text-gray-700">מהפכה בעולם הוויזואלי עבור המוצרים שלך</p>
              </div>
            </div>
          </div>
        </div>
